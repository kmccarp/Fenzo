...
public class ConstraintsTests {
    ...
    public void testHardConstraint1() throws Exception {
        ...
        ConstraintEvaluator zoneConstraint = new UniqueHostAttrConstraint(s -> taskToCoTasksMap.get(s), zoneAttrName);
    ...
    public void testSoftConstraint1() throws Exception {
        Map<String, TaskRequest> taskMap = new HashMap<>();
        final Map<String, Set<String>> taskToCoTasksMap = new HashMap<>();
        UniqueHostAttrConstraint zoneConstraint = new UniqueHostAttrConstraint(s -> taskToCoTasksMap.get(s), zoneAttrName);
    ...
    public void testBalancedHostAttrSoftConstraint() throws Exception {
        Map<String, TaskRequest> taskMap = new HashMap<>();
        final Map<String, Set<String>> taskToCoTasksMap = new HashMap<>();
        BalancedHostAttrConstraint constraint = new BalancedHostAttrConstraint(s -> taskToCoTasksMap.get(s), zoneAttrName, 3);
    ...
    public void testUniqueHostConstraint() throws Exception {
        final Map<String, Set<String>> taskToCoTasksMap = new HashMap<>();
        UniqueHostAttrConstraint uniqueHostConstraint = new UniqueHostAttrConstraint(s -> taskToCoTasksMap.get(s));
