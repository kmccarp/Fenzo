...
//            System.out.println("#leasesRejected=" + schedulingResult.getLeasesRejected());
    ...
    public void testAddingNewRule() throws Exception {
        ...
        ConstraintEvaluator attrConstraint = new HostAttrValueConstraint(hostAttrName, s -> hostAttrVal1);
    ...
    private void testScaleUpDelay(int n) throws Exception {
        ...
        final Action1<AutoScaleAction> callback = autoScaleAction -> {
        ...
        for (int o = 0; o < n; o++) {
            if (o == 1) {
                Thread.sleep((long) (2.5 * scaleupDelaySecs) * 1000L);
            } // delay next round by a while to reset previous delay
